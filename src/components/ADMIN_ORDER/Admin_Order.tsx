...
const Admin_Order = () => {
  ...
  const mutationUp = useMutation<any, Error, UpdateOrderParams>({
    mutationFn: async ({ id, status }: UpdateOrderParams) => {
      const res = await axiosSec.patch(`/ordersAll/${id}`, { status }); // ✅ fixed here
      return res.data;
    },
    onSuccess: () => {
  ...
  const handleUpdateStatus = (id: string) => {
    mutationUp.mutate({ id, status: "Shipped" });
  };
  ...
  const handleViewDetails = (group: OrderGroup) => {
                      ...
                      <div className="p-4 space-y-4">
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            <div className="bg-white/70 col-1 rounded-lg p-2">
                    ...
                    <div className="p-4 sm:p-6">
                      <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
                        ...
                        <Button
                          ...
                          onClick={() => handleDeleteOrder(group?._id)}
                        >
